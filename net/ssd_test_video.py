...
model_path = "models/mb1-ssd-Epoch-0-Loss-nan.pth"
...
# Load video
cap = cv2.VideoCapture('videos/testmovie.mov')
ret, one_image = cap.read()
print("Input Shape: ", one_image.shape)

# Video configuration
fourcc = cv2.VideoWriter_fourcc(*'XVID')
out = cv2.VideoWriter('videos/testmovie.avi', fourcc, 30.0, (one_image.shape[1], one_image.shape[0]))
frame_cnt = 0
